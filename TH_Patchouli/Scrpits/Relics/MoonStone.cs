...
public class MoonStone : CustomRelicModel
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<LunarElement>()];
	...
	{
		if(Owner.GetRelic<SunStone>()!=null)
		{
			await RelicCmd.Replace(Owner.GetRelic<SunStone>(),ModelDb.Relic<SkyStone>().ToMutable());
