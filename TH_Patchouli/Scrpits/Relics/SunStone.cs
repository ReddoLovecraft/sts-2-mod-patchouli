...
public class SunStone : CustomRelicModel
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<SunElement>()];
	...
	{
		if(Owner.GetRelic<MoonStone>()!=null)
		{
			await RelicCmd.Replace(Owner.GetRelic<MoonStone>(),ModelDb.Relic<SkyStone>().ToMutable());
