...
namespace TH_Patchouli.Scrpits.Powers
{
	public sealed class GoldSilverPower : CustomPowerModel
	{
		...
		public override string? CustomPackedIconPath => "res://TH_Patchouli/ArtWorks/Powers/GSP32.png";
		public override string? CustomBigIconPath => "res://TH_Patchouli/ArtWorks/Powers/GSP64.png";
		...
		public override async Task AfterDamageGiven(PlayerChoiceContext choiceContext, Creature? dealer, DamageResult result, ValueProp props, Creature target, CardModel? cardSource)
		{
			...
			PlayTreasureGoldVfx(target, Amount);
			Flash();
