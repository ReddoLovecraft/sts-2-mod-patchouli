...
namespace TH_Patchouli.Scrpits.Cards
{
	...
	public sealed class SatelliteHimawari : PatchouliCardModel
	{
		private static readonly List<ElementEnum> _elementTypes = new() { ElementEnum.Lunar, ElementEnum.Wood };
		...
		public SatelliteHimawari() : base(2, CardType.Power, CardRarity.Ancient, TargetType.Self)
		{
		}
