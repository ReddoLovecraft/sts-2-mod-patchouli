...
namespace TH_Patchouli.Scrpits.Cards
{
	...
	public sealed class Unhurried : PatchouliCardModel
	{
		...
		public Unhurried() : base(1, CardType.Power, CardRarity.Rare, TargetType.Self)
		{
		}
		...
		protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
		{
			...
			await PowerCmd.Apply<UnhurriedPower>(choiceContext, Owner.Creature, DynamicVars.Energy.IntValue, Owner.Creature, this);
		}
