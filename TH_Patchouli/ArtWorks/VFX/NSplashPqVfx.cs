...
public partial class NSplashPqVfx : Node2D
{
    ...
    public static NSplashPqVfx? Create(Vector2 targetPosition, Color tint)
    {
        if (TestMode.IsOn)
        {
            return null;
        }
        NSplashPqVfx nSplashVfx = PreloadManager.Cache.GetScene(scenePath).Instantiate<NSplashPqVfx>(PackedScene.GenEditState.Disabled);
